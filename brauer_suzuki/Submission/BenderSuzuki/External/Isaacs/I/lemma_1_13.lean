...
public import Submission.BenderSuzuki.External.Isaacs.I.definition_1_12

/-!
# Isaacs Lemma 1.13

A source-faithful statement of Isaacs, *Character Theory of Finite Groups*,
Lemma 1.13, phrased for a direct internal sum of irreducible submodules.  The
three clauses say that the homogeneous component is invariant under module
endomorphisms, is the sum of exactly the summands isomorphic to `M`, and that
the multiplicity of the isomorphism class of `M` is independent of the chosen
