...
public import Submission.BenderSuzuki.External.Isaacs.I.lemma_1_13
public import Submission.BenderSuzuki.External.Isaacs.VI.lemma_6_4

/-!
# Isaacs Theorem 6.5

The public theorem below directly states the three conclusions on the
irreducible constituents of the restriction to a normal subgroup: an internal
direct sum, literal conjugacy of every summand, and equality of the
multiplicities of conjugate constituents.
-/
