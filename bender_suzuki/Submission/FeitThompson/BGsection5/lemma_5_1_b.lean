...
import Submission.FeitThompson.BGsection1.CriticalSubgroupLemmas
import Submission.FeitThompson.Burnside.NormalComplement
import Submission.FeitThompson.Extraspecial
import Submission.FeitThompson.LinearAlgebra.BlockElementaryMap
import Submission.Theory.Representation.ConjugateRep
import Submission.FeitThompson.BGsection2.EndFieldRep
...
public theorem quotient_centralizer_card_le_p_of_elementaryAbelian_rank_two
  ...
  · have hfix_pgroup : IsPGroup p (fixedPointSubgroup Q E) := by
    ...
    have hfix_inv : FTIsInvariant Q E (fixedPointSubgroup Q E) := by
      refine ⟨?_⟩
      intro a g
      constructor
      · intro hg
