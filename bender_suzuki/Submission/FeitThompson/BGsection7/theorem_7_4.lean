...
import Submission.Theory.Representation.SolvableDimension
...
private theorem mem_section7HStarFamily_A_of_mem_section7HStarFamily_P_of_normal_no_intermediate
  ...
  · obtain ⟨Q₁, hQ₁, hQ_le_Q₁⟩ := exists_mem_section7HStarFamily_of_mem_family hQfamA
    ...
    have hQsub_inv : FTIsInvariant (↥P) (↥H) (Q.subgroupOf H) := by
      simpa [N] using
...
private theorem theorem_7_4_normal_case
  ...
  have htransP :
    ...
    · have hQ₂_ne_top : Q₂ ≠ ⊤ :=
      ...
      have hP0inv : FTIsInvariant Unit Nsub P0 := by
        refine ⟨?_⟩
        intro _ y
        simp
      have hPk0inv : FTIsInvariant Unit Nsub Pk0 := by
        refine ⟨?_⟩
        intro _ y
        simp
