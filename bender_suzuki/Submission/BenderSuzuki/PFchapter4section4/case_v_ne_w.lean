...
import Submission.BenderSuzuki.PFchapter1section1.proposition_6_c
...
public theorem case_v_ne_w
  ...
  · push Not at hD_fixed_point_free
    ...
    have hQ0Q_invariant_D : FTIsInvariant D Q Q0Q := by
      refine ⟨?_⟩
    ...
    have hQ0Q_invariant_P : FTIsInvariant P Q Q0Q := by
      refine ⟨?_⟩
      intro y q
      simpa [MulAction.compHom_smul_def] using
        (FTIsInvariant.invariant (A := D) (G := Q) (H := Q0Q) (pToD y) q)
