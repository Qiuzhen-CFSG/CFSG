...
import Submission.BenderSuzuki.PFchapter4section2.claim_11
import Submission.BenderSuzuki.PFchapter4section2.claim_5_b
import Submission.BenderSuzuki.PFchapter4section2.claim_8
import Submission.BenderSuzuki.PFchapter4section1.claim_H4_a
import Submission.BenderSuzuki.PFchapter4section1.claim_H4_b
import Submission.BenderSuzuki.PFchapter4section1.claim_H5
import Submission.BenderSuzuki.PFchapter4section1.claim_H6_c
...
private theorem isZGroup_of_fixedPointFree_quotient
  ...
  have hQ0Qinv : FTIsInvariant D Q Q0Q := by
    refine ⟨?_⟩
...
public theorem proposition
  ...
  have hQ0Q_invariant : FTIsInvariant D Q Q0Q := by
    refine ⟨?_⟩
    have hforward : ∀ (d : D) (q : Q), q ∈ Q0Q → d • q ∈ Q0Q := by
      intro d q hq
