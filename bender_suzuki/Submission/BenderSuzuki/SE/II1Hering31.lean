...
import Submission.BenderSuzuki.SE.Permutation
import Submission.BenderSuzuki.SE.PStabilityReduction
import Submission.BenderSuzuki.External.Huppert.V.ComplementTransfer
import Submission.BenderSuzuki.External.Huppert.II.theorem_6_13
import Submission.BenderSuzuki.PFAppendixIII.theorem
import Submission.BenderSuzuki.SE.II1Hering31Finite
import Submission.BenderSuzuki.SE.II1Hering31Abelian
...
public theorem ii1Hering31_involution_fixed_index_le_two
  ...
  let hLinv : FTIsInvariant H N L := by
    refine ⟨?_⟩
    intro h x
    constructor
    · intro hx
    ...
    · intro hx
      ...
      rwa [heq]
  letI : FTIsInvariant H N L := hLinv
