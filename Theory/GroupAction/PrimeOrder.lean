...
theorem isPGroup_of_prime_order_eq_p {G : Type*} [Group G] [Finite G]
  ...
  exact Nat.eq_prime_pow_of_unique_prime_dvd h0
    (by
      intro q hq hqd
      ...
      have hyq' : orderOf (y : H) = q := by simpa [Subgroup.orderOf_coe] using hy
